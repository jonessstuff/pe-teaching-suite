...
${isPresidential ? `- "closure" (REQUIRED — this field is PRINTED on the student/teacher lesson copy, whereas teacher_notes and hfz_reference are NOT rendered in print, so the closure is the ONLY guaranteed place this disclaimer will appear): the closure MUST include, in student-appropriate wording woven naturally into the wrap-up, that the traditional Presidential Fitness Test was revived by the July 2025 executive order, its official updated standards are still being finalized, and today's scoring uses the historical national percentile norms only as a reference point. This is mandatory — do not omit it.\n` : ''}- "teacher_notes": privacy considerations, how to create a safe/supportive environment, and how to handle students who struggle. ${isPresidential ? 'The FIRST sentence of teacher_notes MUST also state: "This lesson reflects the traditional Presidential Fitness Test revived by the July 2025 executive order; the program\'s official updated standards and award criteria are still being finalized, so it uses the historical President\'s Challenge events and national percentile norms." (This repeats the closure disclaimer for the teacher — both are required.)' : 'Reinforce the health-based, non-competitive framing.'}
