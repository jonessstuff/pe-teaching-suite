...
const TOOL_NOTES = {
  ...
  "laser_cutter": "Laser cutter / engraver. CRITICAL DESIGN-vs-OPERATION SPLIT: students DESIGN the file (vector basics — lines/closed paths vs fills, cut vs engrave/raster, correct scale/units, kerf awareness), but ACTUAL LASER OPERATION requires a TRAINED/CERTIFIED ADULT operator — students never run the machine unsupervised, and younger students never operate it at all. Material safety: cut ONLY laser-safe materials (plywood, MDF, cardboard, paper, acrylic) — NEVER PVC/vinyl/unknown plastics (they release chlorine/toxic fumes) — always verify a material before cutting. Also cover fume extraction/ventilation, active FIRE WATCH (never leave the laser running unattended; keep a lid/area clear and know where the extinguisher is), eye safety, and material bed setup. A strong 'design for laser cutting' activity where students produce the vector file is the safest, most inclusive way for all bands to participate.",
  "screen_printing": "Screen printing (silk-screen / stencil printing). Cover the basic process — stencil/screen prep (paper or vinyl stencils, or photo-emulsion for older bands), flooding and pulling ink across the screen with a squeegee, and REGISTRATION (lining up the screen for clean, repeatable multi-color prints, one color per screen/pass). SAFETY: use WATER-BASED inks in schools; any solvent-based inks, screen-cleaning solvents, or photo-emulsion chemicals need ventilation, gloves/eye protection, and are ADULT-handled — cover skin/eye contact, and proper screen cleaning/reclaiming and disposal. Age-appropriate simplification: youngest bands use pre-cut paper or contact-paper stencils with water-based ink on paper/tote bags and NO harsh chemicals (an adult handles any solvent/emulsion step); older bands can take on registration and emulsion with supervision.",
