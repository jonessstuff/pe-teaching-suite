  ...
  return (
    <div className="space-y-10">
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            <div className="flex items-center gap-2">
              <h1 className="text-2xl font-semibold text-ink-50">Library &amp; Media</h1>
            </div>
            <p className="text-sm text-ink-500">Elementary K–5 lesson planning for school librarians</p>
          </div>
        </div>
      </div>
      ...
      <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
        <Link
          to="/library/generate"
          className="card group flex flex-col gap-4 p-6 transition-colors hover:border-blue-500/40"
        >
          <div className="flex items-start justify-between">
            ...
            <ArrowRight
              size={18}
              className="mt-0.5 text-ink-700 transition-transform group-hover:translate-x-1 group-hover:text-blue-400"
            />
          </div>
          <div>
            <p className="font-semibold text-ink-50">Generate a library lesson</p>
            <p className="mt-0.5 text-sm text-ink-500">
              Read-aloud, direct instruction, and hands-on practice — fully structured
            </p>
          </div>
        </Link>
        ...
        >
          <div className="flex items-start justify-between">
            ...
            <ArrowRight
              size={18}
              className="mt-0.5 text-ink-700 transition-transform group-hover:translate-x-1 group-hover:text-violet-400"
            />
          </div>
          <div>
            <p className="font-semibold text-ink-50">Build a library unit</p>
            <p className="mt-0.5 text-sm text-ink-500">
              2–3 connected sessions that build a skill across library visits
            </p>
          </div>
        </Link>

        <Link
          to="/library/makerspace"
        ...
        >
          ...
          <div>
            <p className="font-semibold text-ink-50">Browse my library</p>
            <p className="mt-0.5 text-sm text-ink-500">
        ...
        <Link to="/assessments?module=Library%20%26%20Media" className="card group flex flex-col gap-4 p-6 transition-colors hover:border-indigo-500/40">
          ...
          <div>
            ...
            <p className="mt-0.5 text-sm text-ink-500">Quizzes, rubrics, and exit tickets</p>
          </div>
        </Link>
        ...
        <Link to="/standards-tracker?module=Library%20%26%20Media" className="card group flex flex-col gap-4 p-6 transition-colors hover:border-violet-500/40">
          ...
          <div>
            <p className="font-semibold text-ink-50">Standards Tracker</p>
            <p className="mt-0.5 text-sm text-ink-500">See which standards you&rsquo;ve covered</p>
          </div>
        </Link>
        ...
        <Link to="/pacing-guide?module=Library%20%26%20Media" className="card group flex flex-col gap-4 p-6 transition-colors hover:border-teal-500/40">
          ...
          <div>
            <p className="font-semibold text-ink-50">Pacing Guide</p>
            <p className="mt-0.5 text-sm text-ink-500">Full-year scope &amp; sequence</p>
          </div>
        </Link>
        ...
        <Link to="/import?subject=library&amp;module=Library%20%26%20Media" className="card group flex flex-col gap-4 p-6 transition-colors hover:border-rose-500/40">
          ...
          <div>
            <p className="font-semibold text-ink-50">Import &amp; Enhance</p>
            <p className="mt-0.5 text-sm text-ink-500">Paste an existing lesson and upgrade it</p>
          </div>
        </Link>
        ...
        <Link to="/eoy-narrative?module=Library%20%26%20Media" className="card group flex flex-col gap-4 p-6 transition-colors hover:border-sky-500/40">
          ...
          <div>
            <p className="font-semibold text-ink-50">EOY Narrative</p>
            <p className="mt-0.5 text-sm text-ink-500">Professional end-of-year summary</p>
          </div>
        </Link>
        ...
        <Link to="/activity-bank?module=Library%20%26%20Media" className="card group flex flex-col gap-4 p-6 transition-colors hover:border-yellow-500/40">
          ...
          <div>
            <p className="font-semibold text-ink-50">Activity Bank</p>
        ...
        <Link to="/warm-up-generator?module=Library%20%26%20Media" className="card group flex flex-col gap-4 p-6 transition-colors hover:border-orange-500/40">
          ...
          <div>
            <p className="font-semibold text-ink-50">Warm-up / Bell-ringer</p>
            <p className="mt-0.5 text-sm text-ink-500">Quick warm-ups students start on their own</p>
          </div>
        </Link>
      </div>

      {/* My lessons — compact preview below the tools */}
      <RecentLessonsPanel lessons={lessons} error={error} browseTo="/library/lessons" generateTo="/library/generate" accentText="text-blue-400" moduleContext="Library & Media" />
