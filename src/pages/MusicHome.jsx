...
import { Music, Sparkles, BookOpen, BookMarked, CalendarDays, ClipboardList, Layers, ArrowRight, ArrowLeft, Loader2, BarChart3, CalendarRange, FileInput, ScrollText, PartyPopper, BookCheck } from 'lucide-react'
      ...
      <div className="space-y-5">
        ...
        {lessons !== null && lessons.length === 0 && (
          <p className="text-sm text-ink-600">
            Your music lessons will appear here once you generate your first one.
          </p>
        )}
