...
import { Music, Sparkles, BookOpen, BookMarked, CalendarDays, ClipboardList, Layers, ArrowRight, ArrowLeft, BarChart3, CalendarRange, FileInput, ScrollText, PartyPopper, Flame, BookCheck } from 'lucide-react'
  ...
  return (
    <div className="space-y-10">
      ...
      <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
        ...
        <Link to="/assessments?module=Music" className="card group flex flex-col gap-4 p-6 transition-colors hover:border-indigo-500/40">
          <div className="flex items-start justify-between">
        ...
        <Link to="/standards-tracker?module=Music" className="card group flex flex-col gap-4 p-6 transition-colors hover:border-violet-500/40">
          <div className="flex items-start justify-between">
        ...
        <Link to="/pacing-guide?module=Music" className="card group flex flex-col gap-4 p-6 transition-colors hover:border-teal-500/40">
          <div className="flex items-start justify-between">
        ...
        <Link to="/import?subject=music&amp;module=Music" className="card group flex flex-col gap-4 p-6 transition-colors hover:border-rose-500/40">
          <div className="flex items-start justify-between">
        ...
        <Link to="/eoy-narrative?module=Music" className="card group flex flex-col gap-4 p-6 transition-colors hover:border-sky-500/40">
          <div className="flex items-start justify-between">
        ...
        <Link to="/activity-bank?module=Music" className="card group flex flex-col gap-4 p-6 transition-colors hover:border-yellow-500/40">
          <div className="flex items-start justify-between">
        ...
        <Link to="/warm-up-generator?module=Music" className="card group flex flex-col gap-4 p-6 transition-colors hover:border-orange-500/40">
          <div className="flex items-start justify-between">
