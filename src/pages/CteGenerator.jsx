...
const PATHWAYS = [
  ...
  },
  {
    ...
    description: 'Family & Consumer Sciences, independent living, fashion design & textiles, counseling & mental health careers, workplace readiness',
    icon: HeartHandshake,
  },
  {
...
const TOPIC_PLACEHOLDERS = {
  ...
  human_services: 'e.g. Reading a nutrition label, Building a personal budget, Age-appropriate child activities, Natural vs. synthetic fibers & fabric construction, Garment construction & pattern basics, Design elements & principles in fashion, Fashion history & sustainability, Careers in counseling & mental health, Foundations of psychology & the brain, Ethics & confidentiality in counseling fields, Mental health literacy (career awareness), Mock job interview & workplace readiness',
  ...
  information_technology: 'e.g. Computing systems: hardware, software & networking (Fundamentals of Technology / CompTIA ITF+), HTML/CSS & responsive design, The CIA triad & cyber threats, Network security basics, Cyber ethics & responsible disclosure, Trace a loop in pseudocode, Variables/conditionals/functions, Decomposition & debugging, Bias in algorithms (impacts of computing), AP CSP big ideas',
  ...
  business_mgmt: 'e.g. The four functions of management, Business structures (LLC vs. corporation), A management decision case, Building a basic operating budget, Org charts & workflow, Intro to entrepreneurship, Basic HR concepts, Project management & the project lifecycle (Gantt charts), Resume, portfolio & interview skills (career management), Office productivity & software skills, How AI works — the Five Big Ideas (AI literacy), Using AI tools responsibly & writing good prompts, AI bias, privacy & academic integrity, How AI is changing careers',
  ...
  arts_av: 'e.g. Design principles & typography, Designing a poster or logo, Scriptwriting & storyboarding a shoot (pre-production), Camera composition & 3-point lighting, Non-linear editing workflow & transitions, Copyright & music use in video, Broadcast journalism & interviewing, Digital/interactive media basics, Print production & quality control, Page layout & grids (desktop publishing), Designing a newsletter or yearbook spread, Yearbook ladder & deadline management, Yearbook staff roles & team workflow, Yearbook theme & balanced coverage, Print-ready PDF & publication workflow',
