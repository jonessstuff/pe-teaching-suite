...
export default function TviGenerator() {
    ...
    return (
      <div>
        <div className="mb-6 flex items-center gap-3 print:hidden">
          <Link to="/tvi" className="flex items-center gap-1.5 text-sm text-ink-400 hover:text-ink-200 transition-colors">
            <ArrowLeft size={16} />
  ...
  return (
    <div className="max-w-2xl space-y-8">
      {/* Header */}
      <div>
        <Link to="/tvi" className="mb-3 flex items-center gap-1.5 text-sm text-ink-500 hover:text-ink-200 transition-colors">
          <ArrowLeft size={14} />
          Teacher of the Visually Impaired
        </Link>
