        ...
        >
          ...
          <div>
            ...
            <p className="mt-0.5 text-sm text-ink-500">
              Hospitality, Finance, Marketing, Human Services / FCS, Health Science, Education &amp; Training, Career Readiness (MS foundations), Information Technology, Transportation, Distribution &amp; Logistics, or Manufacturing — 5-phase lesson with work-based learning built in
            </p>
          </div>
        </Link>
