...
export default function SpecialEducationGenerator() {
    ...
    return (
      <div>
        <div className="mb-6 flex items-center gap-3 print:hidden">
          <Link to="/special-education" className="flex items-center gap-1.5 text-sm text-ink-400 hover:text-ink-200 transition-colors">
            <ArrowLeft size={16} />
            Special Education
          </Link>
  ...
  return (
    <div className="max-w-2xl space-y-8">
      {/* Header */}
      <div>
        <Link to="/special-education" className="mb-3 flex items-center gap-1.5 text-sm text-ink-500 hover:text-ink-200 transition-colors">
          <ArrowLeft size={14} />
          Special Education
        </Link>
