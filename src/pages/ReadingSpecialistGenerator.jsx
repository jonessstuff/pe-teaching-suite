    ...
    try {
      const generated =
        sessionMode === 'tutoring'
          ...
          : await generateReadingSpecialist({ skillArea, gradeBand, focus, durationMinutes, groupSize, studentPattern, teacherNotes, handsOn: showHandsOn && handsOn })
            ...
            <label className="flex cursor-pointer items-start gap-3">
              ...
              <div>
                ...
                <p className="mt-0.5 text-xs text-ink-500">
                  Favors letter tiles, movement &amp; multisensory word work over worksheet/seatwork. Elementary (K–2 / 3–5) only.
                </p>
              </div>
            </label>
          </div>
