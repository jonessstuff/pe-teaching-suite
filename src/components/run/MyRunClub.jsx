...
import WalkRunTimer from './WalkRunTimer'
  ...
  return <section className="card overflow-hidden">
    ...
    <div className="space-y-5 p-5 sm:p-6">
      {runs == null ? <p className="flex items-center gap-2 text-sm text-ink-500"><Loader2 size={16} className="animate-spin" /> Loading your progress…</p> : <>
        ...
        <WalkRunTimer recommendedWorkout={training.workout.short} onPatternSelected={setIntervals} onComplete={(totalMs) => setRunningTime(formatRunTime(totalMs, { tenths: false }))} />
